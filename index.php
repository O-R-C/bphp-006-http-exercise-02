...
echo "<li><a href='task1.php'>Страница 1</a></li>";
echo "<li><a href='task2.php'>Страница 2</a></li>";
echo "<li><a href='task2.php'>Страница 3</a></li>";
echo "<li><a href='task2.php'>Страница 4</a></li>";
echo "</ul>";
echo "</div>";
